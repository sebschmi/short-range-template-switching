...
void run_fpa(std::string ref, std::string qry, SeqLib::BamRecord *hit, std::set<std::string> *fpa_contigs, SeqLib::RefGenome *refg, const SeqLib::GenomicRegion &region);

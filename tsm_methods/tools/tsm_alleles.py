...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv,"hcasf:v:l:r:d:b:ut:i:",["create","align","score","fafile=","vcffile=","locifile=","readbam=","alleledir=","bamdir=","untrimmed","trimlen=","indiv="])
        
        cmdopts = 'tsm_alleles.py -c -a -s -v <vcffile> -l <locifile> -r <readbam> -d <alleledir> -b <bamdir> -u -t <trimlen> -i <individual>'
    ...
    if align:
        ...
        for file in files: 
            ...
            cmd= "samtools view -h -b "+bamfile+" "+chrm+":"+start+"-"+stop+" | samtools sort -n -T temp - | bedtools bamtofastq -i - -fq "+bamdir+"/"+file2
            os.system(cmd)
